...
BOT_TOKEN = os.getenv("8650266311:AAGdEPganw9-f8HpW8nv-pAS8A9Ou0GMQTc")
MONGODB_URI = os.getenv("mongodb+srv://riyaziam958_db_user:EV8aPzDA0S3Ynsia@cluster0.m6dnzzo.mongodb.net/?appName=Cluster0")
DATABASE_NAME = os.getenv("@RIYAZXERO", "8650266311:AAGdEPganw9-f8HpW8nv-pAS8A9Ou0GMQTc")
API_URL = os.getenv("http://34.126.208.96:8080/hit")
API_KEY = os.getenv("DRX_POWER_ULTRA_V4")
ADMIN_IDS = [int(id.strip()) for id in os.getenv("ADMIN_IDS", "8127154833").split(",")]
...
def make_aware(dt):
    ...
    if dt is None:
        return None
    if hasattr(dt, 'hit') and dt.tzinfo is None:
...
def main():
    ...
    try:
       ip = requests.get('http://34.126.208.96:8080/hit', timeout=5).text.strip() #https://ifconfig.me
    except Exception:
       ip = "Unknown"
